...
const string strMessageMagic = "TwoColorCoin Signed Message:\n";
...
static int FINAL_POW_HEIGHT = 10000000;
static int FINAL_POW_COUNT = 10000000;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if(nHeight > 1)
       ...
       nSubsidy = 62000 * COIN; //Premin: 10M
     //no pow coin will be created
...
static const int64 nTargetTimespan = 60 * 60; // 20 blocks  
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TwoColorCoin
    bool fStrictPayToScriptHash = true; // Always active in TwoColorCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TwoColorCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017/6/10,TwoColorCoin is upcoming release wish is a great coin!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        //// debug print block.print();
        printf("block.GetHash() == %s\n", block.GetHash().ToString().c_str());
        printf("block.hashMerkleRoot == %s\n", block.hashMerkleRoot.ToString().c_str());
        printf("block.nTime = %u \n", block.nTime);
        printf("block.nNonce = %u \n", block.nNonce);

        assert(block.hashMerkleRoot == uint256("0x42289dac44ac789970130b546bb26fb234d97a26598abe6df3b290698e1c1ad9"));
