...
{
    resize(850, 550);
    setWindowTitle(tr("TwoColorCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a TwoColorCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About TwoColorCoin"), this);
    aboutAction->setToolTip(tr("Show information about TwoColorCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for TwoColorCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("TwoColorCoin client") + QString(" ") + tr("[testnet]"));
                trayIcon->setIcon(QIcon(":/icons/bitcoin_testnet"));
                toggleHideAction->setIcon(QIcon(":/icons/bitcoin_testnet"));
            }

            aboutAction->setIcon(QIcon(":/icons/bitcoin_testnet"));
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("TwoColorCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TwoColorCoin network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid TwoColorCoin address or malformed URI parameters."));
    }
